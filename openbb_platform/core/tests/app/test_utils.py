...
def test_multiindex_round_trip_preserves_level_names(index_names):
    """Test MultiIndex round trips with named and unnamed index levels."""
    ...
    result = basemodel_to_df(df_to_basemodel(expected.copy()))
